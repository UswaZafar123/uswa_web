...
import { userRegister } from "../Actions/UserActions"; // Action creator for registration
...
const Register = () => {
  ...
  const handleRegister = (e) => {
    ...
    const reqObj = { name, email, password, role };

    dispatch(userRegister(reqObj)); // Dispatch registration action
  };
